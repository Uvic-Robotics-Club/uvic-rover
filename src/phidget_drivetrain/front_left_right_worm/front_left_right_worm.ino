...
const int LEFT_MOTOR_PWM_PIN = 6;   // PWM pin for left motor
const int LEFT_MOTOR_DIR_PIN = 7;   // Direction pin for left motor
const int RIGHT_MOTOR_PWM_PIN = 9;  // PWM pin for right motor
const int RIGHT_MOTOR_DIR_PIN = 8;  // Direction pin for right motor


// Pin definitions for encoders
const int LEFT_ENCODER_PIN_A = 4;   // Left encoder pin A
const int LEFT_ENCODER_PIN_B = 5;   // Left encoder pin B
...
const int gripperPWM = 4; // PWM pin
const int gripperDir1 = 5; // Direction pin 1
const int gripperDir2 = 6; // Direction pin 2
...
//  pinMode(
  // SETUP PINS FOR ENCODER AND ARM
...
//
//  right_encoder_pub.publish(right_encoder_value);
//  right_encoder_pub.publish(left_encoder_value);
